...
from batch_generator_step1_t1c import validate_generator,training_generator
...
saveBestModel=ModelCheckpoint("/home/step1/spdropout_fold_batch_t1c.h5", monitor='loss', verbose=1, save_best_only=True, mode='min')
...
history=model.fit_generator(generator=train_generator(batch_size),
                    ...
                    workers=4,
                    verbose = 2)
model.save("/home/step1/spdropout_fold_batch_t1c.h5")

with open('/home/step1/spdropout_fold_batch_t1c.txt','w') as f:
